...
export default function AdminOrdersPage() {
  ...
  const { mutate: updatePaymentStatus, isPending: isPaymentUpdating } = useMutation({
    mutationFn: orders.updatePaymentStatus,
  ...
  // ⏳ Unified loading state (you could also use `isPending`)
  ...
  updatePaymentStatus={updatePaymentStatus} // ✅ THIS MUST EXIST
