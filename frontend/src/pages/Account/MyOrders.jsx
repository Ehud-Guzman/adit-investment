...
import { FiChevronDown, FiChevronUp, FiPackage, FiCalendar, FiCreditCard, FiTruck, FiShoppingBag, FiMapPin } from "react-icons/fi";
...
const statusConfig = {
  processing: {
    bg: "bg-gradient-to-r from-blue-50 to-[#e6f4ea]",
    text: "text-blue-700",
  ...
  delivered: {
    bg: "bg-gradient-to-r from-[#e6f4ea] to-[#c8e8d5]",
    text: "text-[#006341]", 
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center space-y-4 p-8 max-w-md">
          ...
          <p className="text-gray-600">Please log in to view your order history and track your purchases.</p>
          <button className="bg-gradient-to-r from-[#00A651] to-[#007a40] text-white px-6 py-3 rounded-xl font-medium mt-4
                            hover:from-[#007a40] hover:to-[#006030] transition-all duration-300 shadow-md hover:shadow-lg">
            Sign In
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center space-y-4 p-8 max-w-md">
          ...
          <p className="text-red-600">{error?.response?.data?.message || "Failed to load your orders."}</p>
          <button 
            onClick={() => window.location.reload()} 
            className="bg-gradient-to-r from-[#1e90ff] to-[#0066cc] text-white px-6 py-3 rounded-xl font-medium mt-4
                      hover:from-[#0066cc] hover:to-[#0050a3] transition-all duration-300 shadow-md hover:shadow-lg"
          >
            Try Again
          </button>
        </div>
      ...
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center space-y-6 p-8 max-w-md">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-500">Your shopping journey starts here! Discover amazing products and make your first order.</p>
          </div>
          <a
            href="/shop"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#00A651] to-[#007a40] text-white px-8 py-3 rounded-xl 
                      font-medium mt-4 hover:from-[#007a40] hover:to-[#006030] transition-all duration-300 shadow-md hover:shadow-lg
  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 ml-11">Track and manage all your purchases</p>
        <div className="ml-11 mt-3 flex items-center gap-4 text-sm text-gray-400">
      ...
      <div className="space-y-6">
        {orders.map((order, index) => {
          ...
          const statusStyle = statusConfig[order.orderStatus] || statusConfig.processing;
          ...
          return (
            ...
            >
              <Card className={cn(
                ...
                <div className={cn("absolute top-0 left-0 w-full h-1", statusStyle.dot)} />
                          ...
                          <div className="mb-6">
                            ...
                            <div className="space-y-4">
                              {order.items.map((item, idx) => {
                                ...
                                const image = item?.image?.replace(/\\/g, "/") || "/placeholder.jpg";
                                ...
                                return (
                                  <motion.div
                                    ...
                                    className="flex items-center gap-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-gray-100 hover:bg-white/80 transition-all duration-200"
                                  >
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <div className="flex items-center gap-4 text-sm text-gray-600">
                                        <span>Ksh {price?.toLocaleString?.()} each</span>
                              ...
                              {order.shippingAddress ? (
                                <div className="text-sm text-gray-600 space-y-1">
                                  ...
                                  {order.shippingAddress.note && (
                                    <p className="text-gray-500 italic mt-2 p-2 bg-gray-50 rounded">
