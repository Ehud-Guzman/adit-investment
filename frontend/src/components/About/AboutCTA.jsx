      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <motion.a
            ...
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-primary text-white font-bold rounded-lg shadow-md hover:bg-primary/90 transition-all flex items-center gap-2"
          >
          ...
          <motion.a
            ...
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 border-2 border-gray-300 hover:border-primary text-gray-800 hover:text-primary rounded-lg font-medium transition-all flex items-center gap-2"
          >
            <FiPhone /> Call Now
          </motion.a>
        </div>
          ...
          {[FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaWhatsapp].map(
            (Icon, i) => (
              <motion.a
                ...
                whileHover={{ y: -5 }}
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 rounded-full bg-muted hover:bg-primary/10 text-primary border border-gray-200 flex items-center justify-center transition-all"
              >
