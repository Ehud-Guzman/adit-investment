...
export default function OrderDetails({ order }) {
  ...
  const formatAddress = () => {
    const { fullName, address, city, postalCode, country, phone } = order.shippingAddress || {};
    return (
      <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 pb-3 border-b border-gray-200">
              ...
              <h3 className="font-bold text-lg">Order Items ({enrichedItems.length})</h3>
            </div>
          ...
          <div className="space-y-8">
            ...
            >
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <PaymentBadge status={order.paymentStatus || (order.isPaid ? "paid" : "pending")} />
                </div>
                <div className="flex justify-between">
            ...
            >
              <ul className="space-y-3 text-sm">
                ...
                <li className={order.deliveredAt ? "flex items-start gap-3" : "flex items-start gap-3 opacity-60"}>
